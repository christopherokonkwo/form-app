...
<head>
    ...
    @if (enabledDarkMode($jsVars['user']['dark_mode']))
        <link rel="stylesheet"
            href="//cdn.jsdelivr.net/gh/highlightjs/cdn-release@10.5.0/build/styles/sunburst.min.css">
    @else
...
<body class="mb-5" @if (enabledDarkMode($jsVars['user']['dark_mode'])) data-theme="dark" @endif
    @if (usingRightToLeftLanguage($jsVars['user']['locale'])) data-lang="rtl" @endif>
